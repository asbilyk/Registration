<?php /* Smarty version Smarty-3.1.15, created on 2016-03-15 00:28:47
                    ...
                    <fieldset>
                        <ul>
                            <li class="form-row"><label>Change your name:</label>
                                <input name="name" type="text" class="text-input required" id="log-name" placeholder="Ivanov"/>
                            ...
                            <li class="form-row"><label>Change your email:</label>
                                <input name="email" type="text" id="change-email" class="text-input required email" placeholder="ivanov@mail.com"/>
                                <input type="button"   class="btn-user-submit img-swap" id="btn-change-email"/>
                            </li>
                            <li class="form-row"><label>Change your website:</label>
                                <input name="website" type="text" id="change-web" class="text-input required website" placeholder="ivanov.com"/>
