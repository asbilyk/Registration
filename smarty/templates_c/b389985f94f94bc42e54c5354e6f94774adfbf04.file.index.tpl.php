<?php /* Smarty version Smarty-3.1.15, created on 2016-03-15 16:43:04
            ...
            <div class="form">
                <form id="form-sign-up" class="styled" action="" method="post">
                    <fieldset>
                        <ul>
                            <li class="form-row"><label>Name:</label>
                                <input name="name" type="text" id="name" class="text-input required" placeholder="Ivan"/>
                            </li>
                            ...
                            <li class="form-row"><label>Email:</label>
                                <input name="email" type="text" id="register-email" class="text-input required email" placeholder="ivan@mail.com"/>
                            </li>
                            <li class="form-row"><label>Website:</label>
                                <input name="website" type="text" id="register-web" class="text-input required website" placeholder="ivan.com"/>
                            </li>
                            <li class="form-row"><label>Password:</label>
